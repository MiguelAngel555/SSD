<template>
  ...
  ========================================== -->
    ...
    <!-- =========================================
       TARJETA: CÓDIGOS DE RECUPERACIÓN
  ========================================== -->
    <div v-if="recoveryCodes.length" class="widget-contorno settings-card codes-vault">
        <div class="alert a-warning">
            <strong>¡Importante!</strong> Guarda estos códigos de recuperación en un lugar seguro. Cada uno solo se
            puede usar una vez y no volverán a mostrarse.
        </div>
    ...
    <div v-if="!dosFAActiva" class="widget-contorno settings-card">
        ...
        <div v-if="setupData" class="setup-confirmation">
            ...
            <div v-if="setupData.method === 'app'" class="setup-app-box">
                ...
                <p class="fh mt3">O ingresa esta clave manualmente: <code
                        class="secret-code">{{ setupData.secret }}</code></p>
            </div>
            ...
            <div class="field">
                ...
                <input v-model.trim="confirmCode" type="text" class="input input-3d-lit text-center font-code"
  ...
  ========================================== -->
    <div v-if="dosFAActiva" class="widget-contorno settings-card danger-zone">
        ...
        <p class="sz-sm text-dim mb4">Al desactivar esta opción, tu cuenta será vulnerable a accesos no autorizados.
            Necesitamos tu contraseña para proceder.</p>

        <div class="field">
            <label class="fl text-danger">Confirma tu contraseña<span class="req">*</span></label>
            <input v-model="passwordDisable" type="password" class="input input-3d-lit input-danger"
                placeholder="••••••••" />
        </div>
