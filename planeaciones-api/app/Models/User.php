...
use Illuminate\Database\Eloquent\Factories\HasFactory; // <-- 1. Agregamos esta importación
...
{
    use HasApiTokens, HasFactory, Notifiable, SoftDeletes; // <-- 2. Agregamos HasFactory aquí
